<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ns1:article">
        <ns1:article  xmlns="http://www.w3.org/ns/rdfa#" xmlns:xsd="http://www.w3.org/2001/XMLSchema#">
            ...
            <xsl:attribute name="about">https://github.com/XML-tim17/ScientificArticles/<xsl:value-of select="./ns1:id"/></xsl:attribute>
    ...
    <xsl:template match="ns1:article/ns1:abstract/ns1:keywords/ns1:keyword">
        <xsl:copy>
